[![스타벅스] (https://github.com/5juheon/starbucks/blob/master/images/starbucks_logo.png)](https://github.com/5juheon/starbucks)
# 1. 프로젝트 명 : starbuck Clone Codding
...
### 1. 검색최적화를 위한 오프그래프
웹 페이지가 '소셜 미디어(페이스 북)' 등 공유될때 우선적으로 활용되는 정보를 지정
